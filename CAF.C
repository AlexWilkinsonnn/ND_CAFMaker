...
CAF::CAF( std::string filename, bool isGas )
{
  ...
  cafMVA->Branch("FDPredCVNResultNutau", &FDPredCVNResultNutau, "FDPredCVNResultNutau/F" );
  cafMVA->Branch("FDPredCVNResultNC", &FDPredCVNResultNC, "FDPredCVNResultNC/F" );
  cafMVA->Branch("FDPredEvRecoNumu", &FDPredEvRecoNumu, "FDPredEvRecoNumu/F" );
  cafMVA->Branch("FDPredEvRecoHadNumu", &FDPredEvRecoHadNumu, "FDPredEvRecoHadNumu/F" );
  cafMVA->Branch("FDPredEvRecoLepNumu", &FDPredEvRecoLepNumu, "FDPredEvRecoLepNumu/F" );
  cafMVA->Branch("FDPredEvRecoNue", &FDPredEvRecoNue, "FDPredEvRecoNue/F" );
  cafMVA->Branch("FDPredEvRecoHadNue", &FDPredEvRecoHadNue, "FDPredEvRecoHadNue/F" );
  cafMVA->Branch("FDPredEvRecoLepNue", &FDPredEvRecoLepNue, "FDPredEvRecoLepNue/F" );
  cafMVA->Branch("FDPredEvRecoNC", &FDPredEvRecoNC, "FDPredEvRecoNC/F" );
  cafMVA->Branch("FDPredEvRecoHadNC", &FDPredEvRecoHadNC, "FDPredEvRecoHadNC/F" );
  cafMVA->Branch("FDPredEvRecoLepNC", &FDPredEvRecoLepNC, "FDPredEvRecoLepNC/F" );
  ...
  cafMVA->Branch("FDTrueCVNResultNutau", &FDTrueCVNResultNutau, "FDTrueCVNResultNutau/F" );
  cafMVA->Branch("FDTrueCVNResultNC", &FDTrueCVNResultNC, "FDTrueCVNResultNC/F" );
  cafMVA->Branch("FDTrueEvRecoNumu", &FDTrueEvRecoNumu, "FDTrueEvRecoNumu/F" );
  cafMVA->Branch("FDTrueEvRecoHadNumu", &FDTrueEvRecoHadNumu, "FDTrueEvRecoHadNumu/F" );
  cafMVA->Branch("FDTrueEvRecoLepNumu", &FDTrueEvRecoLepNumu, "FDTrueEvRecoLepNumu/F" );
  cafMVA->Branch("FDTrueEvRecoNue", &FDTrueEvRecoNue, "FDTrueEvRecoNue/F" );
  cafMVA->Branch("FDTrueEvRecoHadNue", &FDTrueEvRecoHadNue, "FDTrueEvRecoHadNue/F" );
  cafMVA->Branch("FDTrueEvRecoLepNue", &FDTrueEvRecoLepNue, "FDTrueEvRecoLepNue/F" );
  cafMVA->Branch("FDTrueEvRecoNC", &FDTrueEvRecoNC, "FDTrueEvRecoNC/F" );
  cafMVA->Branch("FDTrueEvRecoHadNC", &FDTrueEvRecoHadNC, "FDTrueEvRecoHadNC/F" );
  cafMVA->Branch("FDTrueEvRecoLepNC", &FDTrueEvRecoLepNC, "FDTrueEvRecoLepNC/F" );
